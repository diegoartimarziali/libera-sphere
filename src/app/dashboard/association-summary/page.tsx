...
export default function AssociationSummaryPage() {
    ...
    return (
        <div className="bg-background text-foreground min-h-screen p-4 sm:p-8">
            <Card className="max-w-3xl mx-auto">
                <CardHeader>
                    <CardTitle>Riepilogo Passaporto Associazione</CardTitle>
                    <CardDescription>
                ...
                <CardFooter className="flex justify-end">
                    <Button onClick={() => router.push('/dashboard/payments')}>Procedi al Pagamento</Button>
                </CardFooter>
            </Card>
        </div>
    );
